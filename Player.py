...
class Player:
    ...
    def getNewBoardPos(self, board, thisPlayer, index, players, drawPiles, activePlayer):
        if thisPlayer.currentSpace.spaceName == "Go":
            ...
            if thisPlayer == activePlayer:
                drawPiles.drawAssistTrophy(thisPlayer, players)
            ...
            if thisPlayer.inJail == False:
                ...
                if index == 0:
                    ...
                    board.blit(self.p2Img, (80, 910))
                elif index == 2:
                    board.blit(self.p3Img, (50, 880))
                else:
            ...
            if index == 0:
                board.blit(self.p1Img, (40, 80))
            elif index == 1:
                board.blit(self.p2Img, (40, 110))
            elif index == 2:
                board.blit(self.p3Img, (70, 80))
            else:
                board.blit(self.p4Img, (70, 110))
        elif thisPlayer.currentSpace.spaceName == "Falco":
            if index == 0:
                board.blit(self.p1Img, (160, 80))
            elif index == 1:
                board.blit(self.p2Img, (160, 110))
            elif index == 2:
                board.blit(self.p3Img, (190, 80))
            else:
                board.blit(self.p4Img, (190, 110))
